...
```kotlin
dependencies {
    modImplementation("net.fabricmc:fabric-language-kotlin:1.9.0+kotlin.1.8.10")
}
```
...
```json
{
    ...
    "depends": {
        "fabric-language-kotlin": ">=1.9.0+kotlin.1.8.10"
    }
}
```
...
- **`atomicfu`** 0.19.0 [GitHub](https://github.com/Kotlin/kotlinx.atomicfu)
