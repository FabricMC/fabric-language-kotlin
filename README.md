...
```kotlin
dependencies {
    modImplementation("net.fabricmc:fabric-language-kotlin:1.13.10+kotlin.2.3.21")
}
```
...
```json
{
    ...
    "depends": {
        "fabric-language-kotlin": ">=1.13.10+kotlin.2.3.21"
    }
}
```
...
- **`kotlin-stdlib`** 2.3.21 [Docs](https://kotlinlang.org/docs/home.html), [API docs](https://kotlinlang.org/api/latest/jvm/stdlib/), [GitHub](https://github.com/JetBrains/kotlin)
- **`kotlin-reflect`** 2.3.21 [Docs](https://kotlinlang.org/docs/reflection.html), [API docs](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.reflect/)
...
- **`atomicfu`** 0.32.1 [GitHub](https://github.com/Kotlin/kotlinx.atomicfu)
