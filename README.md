...
```kotlin
dependencies {
    modImplementation("net.fabricmc:fabric-language-kotlin:1.9.3+kotlin.1.8.21")
}
```
...
```json
{
    ...
    "depends": {
        "fabric-language-kotlin": ">=1.9.3+kotlin.1.8.21"
    }
}
```
...
- **`kotlin-stdlib`** 1.8.21 [Docs](https://kotlinlang.org/docs/home.html), [API docs](https://kotlinlang.org/api/latest/jvm/stdlib/), [GitHub](https://github.com/JetBrains/kotlin)
- **`kotlin-reflect`** 1.8.21 [Docs](https://kotlinlang.org/docs/reflection.html), [API docs](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.reflect/)
...
- **`atomicfu`** 0.20.2 [GitHub](https://github.com/Kotlin/kotlinx.atomicfu)
