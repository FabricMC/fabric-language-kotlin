...
```kotlin
dependencies {
    modImplementation("net.fabricmc:fabric-language-kotlin:1.12.0+kotlin.2.0.20")
}
```
...
```json
{
    ...
    "depends": {
        "fabric-language-kotlin": ">=1.12.0+kotlin.2.0.20"
    }
}
```
...
- **`kotlinx-io-core`** 0.5.3 [API docs](https://kotlin.github.io/kotlinx-io/kotlinx-io-core/index.html), [GitHub](https://github.com/Kotlin/kotlinx-io)
- **`kotlinx-io-bytestring`** 0.5.3 [API docs](https://kotlin.github.io/kotlinx-io/kotlinx-io-bytestring/index.html)
